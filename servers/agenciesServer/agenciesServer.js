...
md.passAgency = function(option, cb) {
  ...
  agenciesDao.findById(id, function(data){
    var d = data.data[0];
    const {alipay,bank_address,bank_num,email,mobile,name,user_id,pwd,wechat} = d;
    const addParam = [alipay,bank_address,bank_num,email,mobile,name,user_id,pwd,wechat]
